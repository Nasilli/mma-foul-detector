...
# ==================== LOAD EVENT ====================
file_path <- here("Raw PBP Data", "UFC322-dellamaddalena-makhachev-15-11-2025.html")
...
write_csv(fouls_df5, "foul_detection_output_event5.csv")
fouls_df5
