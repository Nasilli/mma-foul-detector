...
# ==================== LOAD EVENT ====================
file_path <- here("Raw PBP Data", "UFCvegas-107-blanchfield-barber-31-05-2025.html")
...
write_csv(fouls_df4, "foul_detection_output_event4.csv")
fouls_df4

cat("\n✅ Event 34analysis complete!\n")
